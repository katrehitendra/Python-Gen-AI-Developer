...
from source import get_citations
...
def get_citations(api_url,input_text):
  """
  ...
  while url:
    ...
    for item in data["data"]["data"]:
      ...
      citations.append({"citations": matched_sources})
...
def index():
    if request.method == "POST":
        ...
        citations = get_citations(api_url, input_text)
